        ...
        <div className="post">
          ...
          <div className="comments">
            ...
            <p>
              ...
              Distinctio neque quo quae totam. Enim fuga aliquid corporis! Aut
              nisi magni similique repudiandae veniam, dolores, harum nemo
              necessitatibus voluptatum, doloremque ex?
            </p>
            <div className="pRow3">
              <div className="vote">
                <div className="like">
